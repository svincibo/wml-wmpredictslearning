...
remove = [27 32 68];
% 68 still processing on brainlife
...
% Add columns that represent the pathways. 
t.lpvp = nanmean([t.leftparc_fa t.lefttpc_fa t.leftmdlfang_fa t.leftmdlfspl_fa], 2);
t.rpvp = nanmean([t.leftparc_fa t.lefttpc_fa t.leftmdlfang_fa t.leftmdlfspl_fa], 2);
t.pvp = nanmean([t.leftparc_fa t.lefttpc_fa t.leftmdlfang_fa t.leftmdlfspl_fa], 2);
...
% zscore each column separately, converting to array.
...
rt1_idx = 6;
acc1_idx = 11;
first_fa_idx = 19; %15=fa, 16=md, 19=r1
% first_t1t2_idx = 17;
% first_ndi_idx = 18;
step = 8;
corr_thresh = .3;
...
modelspec = 'mt_learningrate~leftparc_fa+leftparc_ndi+leftparc_t1t2';
...
% y = t.mt_learningrate;
% x = [t.leftparc_fa t.leftparc_ndi t.leftparc_t1t2];
% 
% % Fit.
...
n = size(t, 1);
text(-1.0, 1.5, ['adjr2 = ' num2str(mdl.Rsquared.Adjusted)])
...
% Fit a linear model: Does wm predict mt at day 1?
modelspec = 'rt_learningrate~leftparc_fa+leftparc_ndi+leftparc_t1t2';
mdl = fitlm(t, modelspec);
mdl.Coefficients
anova(mdl, 'summary')
disp(mdl.Rsquared.Adjusted)
...
% Fit a linear model: Does wm predict mt at day 1?
modelspec = 'mt_learningrate~leftslf1and2_fa+leftslf1and2_ndi+leftslf1and2_t1t2';
mdl = fitlm(t, modelspec);
mdl.Coefficients
anova(mdl, 'summary')
disp(mdl.Rsquared.Adjusted)
...
% Fit a linear model: Does wm predict mt at day 1?
modelspec = 'rt_learningrate~leftslf1and2_fa+leftslf1and2_ndi+leftslf1and2_t1t2';
mdl = fitlm(t, modelspec);
mdl.Coefficients
anova(mdl, 'summary')
disp(mdl.Rsquared.Adjusted)
...
% Fit a linear model: Does wm predict mt at day 1?
modelspec = 'mt_learningrate~leftifof_fa+leftifof_ndi+leftifof_t1t2';
mdl = fitlm(t, modelspec);
mdl.Coefficients
anova(mdl, 'summary')
disp(mdl.Rsquared.Adjusted)
...
% Fit a linear model: Does wm predict mt at day 1?
modelspec = 'rt_learningrate~leftifof_fa+leftifof_ndi+leftifof_t1t2';
mdl = fitlm(t, modelspec);
mdl.Coefficients
anova(mdl, 'summary')
disp(mdl.Rsquared.Adjusted)
...
% Fit a linear model: Does wm predict mt at day 1?
modelspec = 'mt_learningrate~leftilf_fa+leftilf_ndi+leftilf_t1t2';
mdl = fitlm(t, modelspec);
mdl.Coefficients
anova(mdl, 'summary')
disp(mdl.Rsquared.Adjusted)
...
% Fit a linear model: Does wm predict mt at day 1?
modelspec = 'rt_learningrate~leftilf_fa+leftilf_ndi+leftilf_t1t2';
mdl = fitlm(t, modelspec);
mdl.Coefficients
anova(mdl, 'summary')
disp(mdl.Rsquared.Adjusted)
